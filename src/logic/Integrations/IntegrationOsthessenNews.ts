...
export class IntegrationOsthessenNews extends BaseIntegration {
    ...
    constructor() {
        super();
        this.requests = new Requests(OSTHESSEN_NEWS_BASE_URL);
        this.selectorMagic = new SelectorMagicOsthessenNews(this.requests);
        this.processing = new ProcessingOsthessenNews(this.requests);
