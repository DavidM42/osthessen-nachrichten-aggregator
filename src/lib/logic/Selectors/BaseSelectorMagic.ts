...
export abstract class BaseSelectorMagic {
	constructor(
		protected currentIntegration: Integrations,
	...
	/**
	 * Classifies as ad or not by checking for typical ad elements in the document
	 * @param doc
	 */
	public abstract isAd(doc: Document): boolean;
}
